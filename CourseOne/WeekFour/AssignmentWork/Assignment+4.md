...
```
    ...
    <ipython-input-6-ea9125e733c0> in <module>()
         26 
         27     return df[df['is_end_recession'] == True].iloc[0]['Quarters']
    ---> 28 get_recession_end()
    

    <ipython-input-6-ea9125e733c0> in get_recession_end()
          2     '''Returns the year and quarter of the recession end time as a 
          3     string value in a format such as 2005q3'''
    ----> 4     df = get_gdp_figures()
          5     quarters = df['Quarters'].astype('category', categories=df['Quarters'], ordered=True)
          6     df = df[quarters >= '2008q3']


    NameError: name 'get_gdp_figures' is not defined
...
```
    ...
    /opt/conda/lib/python3.6/site-packages/IPython/core/interactiveshell.py:2717: PerformanceWarning: indexing past lexsort depth may impact performance.
...
```
    ...
    /opt/conda/lib/python3.6/site-packages/ipykernel/__main__.py:7: UserWarning: Boolean Series key will be reindexed to match DataFrame index.
    /opt/conda/lib/python3.6/site-packages/IPython/core/interactiveshell.py:2827: PerformanceWarning: indexing past lexsort depth may impact performance.
    ...
    (True, 0.00011951878869097858, 'non-university town')
